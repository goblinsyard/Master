odoo.define('flexibite_ee_advance.dashboard', function (require) {
    "use strict";
                ...
                if(res){
                    ...
                    if(res['login_user_img']){
                        self.$el.find('#image_viewer').html('<img class="rounded-circle" style="width:61px" src="data:image/jpeg;base64,'+res['login_user_img']+'"/>');
                         ...
                         self.$el.find('#image_viewer').html('<img class="rounded-circle" style="width:61px" src="/flexibite_ee_advance/static/src/img/icons/user.png">');
                    }
