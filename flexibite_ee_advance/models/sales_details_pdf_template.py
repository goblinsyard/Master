...
class sales_details_pdf_template(models.AbstractModel):
    _name = 'report.flexibite_ee_advance.sales_details_pdf_template'
    _description = 'report flexibite_ee_advance sales_details_pdf_template'

    @api.model
    def _get_report_values(self, docids, data=None):
        report = self.env['ir.actions.report']. \
            _get_report_from_name('flexibite_ee_advance.sales_details_pdf_template')
...
class pos_sales_report_pdf_template(models.AbstractModel):
    ...
    _description = 'report flexibite_ee_advance pos_sales_report_pdf_template'
