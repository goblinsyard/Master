odoo.define('flexibite_ee_advance.kanban_record', function (require) {
"use strict";
	...
	KanbanRecord.include({
        ...
        pos_line_print: function(e){
            ...
            console.log("url >>> ",url);
//            PDF Report
	        self.do_action('flexibite_ee_advance.report_item_table_order_id',{additional_context:{
	            active_ids:[kitchen_button_id],
	        }}).fail(function(error){
	        	console.log("Connection lost", error);
	        });
//	        Thermal Report
            var report_name = "flexibite_ee_advance.report_item_table_order1";
            var params = {
...
//                            self.receipt_queue.unshift(r);
        ...
        main_print_button: function(e){
            ...
            console.log("url >>>> ",url);
//            PDF Report
	        self.do_action('flexibite_ee_advance.report_table_order_id',{additional_context:{
	            active_ids:[kitchen_button_id],
	        }}).fail(function(error){
	        	console.log("Connection lost", error);
	        });
//	        Thermal Report
//            var report_name = "flexibite_ee_advance.report_table_order_receipt";
//            var params = {
//				model: 'ir.actions.report',
//				method: 'get_html_report',
//				args: [Number(kitchen_button_id), report_name],
