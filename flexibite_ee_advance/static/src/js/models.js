odoo.define('flexibite_ee_advance.models', function (require) {
	...
	models.PosModel.prototype.models.push({
        ...
        fields: ['coin_value','number','subtotal'],
        loaded: function(self,values){
...
//        set_resturant_mode: function(mode){
//        	if(mode == 'drive_through_mode'){
//        		this.set_restuarant_mode('drive_through_mode');
//        		$("div#drive_through_mode").addClass('selected-menu');
//        		$("div#dine_in_mode").removeClass('selected-menu');
//        		$("div#online_mode").removeClass('selected-menu');
//        	} else if (mode == 'dine_in_mode'){
//        		this.set_restuarant_mode('dine_in_mode');
//        		$("div#dine_in_mode").addClass('selected-menu');
//        		$("div#drive_through_mode").removeClass('selected-menu');
//        		$("div#online_mode").removeClass('selected-menu');
//        	} else if (mode == 'online_mode'){
//        		this.set_restuarant_mode('online_mode');
//        		$("div#online_mode").addClass('selected-menu');
//        		$("div#drive_through_mode").removeClass('selected-menu');
//        		$("div#dine_in_mode").removeClass('selected-menu');
//        	}
...
//    	set_restuarant_mode: function(rest_mode){
//    		this.rest_mode = rest_mode;
//    		if(rest_mode == 'drive_through_mode'){
//        		this.set_restuarant_mode('drive_through_mode');
//        		$("div#drive_through_mode").addClass('selected-menu');
//        		this.set_restuarant_mode('drive_through_mode');
//        		$("div#dine_in_mode").removeClass('selected-menu');
//        		$("div#online_mode").removeClass('selected-menu');
//        	} else if (rest_mode == 'dine_in_mode'){
//        		this.set_restuarant_mode('dine_in_mode');
//        		$("div#dine_in_mode").addClass('selected-menu');
//        		$("div#drive_through_mode").removeClass('selected-menu');
//        		$("div#online_mode").removeClass('selected-menu');
//        	} else if (rest_mode == 'online_mode'){
//        		this.set_restuarant_mode('online_mode');
//        		$("div#online_mode").addClass('selected-menu');
//        		$("div#drive_through_mode").removeClass('selected-menu');
//        		$("div#dine_in_mode").removeClass('selected-menu');
...
//                			var modifier_list = selected_line.modifier_line;
//                			_.each(modifier_list, function(mod_line){
//                				mod_line['drive_through_mode'] = true;
//                			})
//                		}
//                        }
//                    }
            ...
            this.orderlines.each(function(line){
                ...
                if (typeof resume[line_hash] === 'undefined') {
                    ...
                    resume[line_hash] = {
                        ...
                        drive_through_mode: line.get_drive_through_mode() || false,
                        dine_in_mode: line.get_dine_in_mode() || false,
                        online_mode: line.get_online_mode() || false,
