		...
		_onNotification: function(notifications){
			...
			for (var notif of notifications) {
				if(notif[1] && notif[1].terminal_lock){
	    		    ...
	    		    if(notif[1].delivery_pos_order[0] && notif[1].delivery_pos_order[0].modified_order){
	    		        $('#sale_note_count').addClass('blink');
	    		    }
					...
					self.render_delivery_order_list(delivery_orders);
					self.chrome.render_sale_note_order_list(self.pos.db.pos_orders);
                }
	    	}
		},
...
//		},
		sale_note_chrome: function(){
			...
			$('#sale_note_count').removeClass('blink');
		},
...
//        	},
        	...
        	self.x_report = function(){
        		...
        		self.pos.chrome.do_action('flexibite_ee_advance.pos_x_report',{additional_context:{
...
//        	    	$('#toggle_image').attr('src','/flexibite_ee_advance/static/src/img/icons/angle-down.svg')
//        	    }else{
//        	    	$('#toggle_image').addClass('right');
//        	    	$('#toggle_image').attr('src','/flexibite_ee_advance/static/src/img/icons/angle-right.png')
//        	    }
        	});
        },
	});
